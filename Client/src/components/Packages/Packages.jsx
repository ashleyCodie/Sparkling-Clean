 ...
 {/* <!-- Scheduling Request Modal --> */}
            {showSchedule &&
                ...
                <div id="id01" className="scheduling-modal">
                    ...
                    <form className="scheduling-modal-content" onSubmit={handleSubmit(scheduleSubmit)}>
                        <div className="containerSch">
                            ...
                            <label for="address"><b><i>Address</i></b></label>
                            <input type="text" name="address" required />

                            <label for="crossstreet"><b><i>Major Cross Streets</i></b></label>
                            <input type="text" name="crossstreets" required />

                            <label for="date"><b><i>Requested Date</i></b></label>
                            <input type="date" name="date" required />


                            <label for="time"><b><i>Requested Time</i></b></label>
